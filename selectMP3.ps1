...
$target_filename = "*.mp3"
# 出力するログファイル名
$log_filename = "PS1_test_SLCT.log"
# 動作環境のルートフォルダ
...
$msg1 = $target_filename + "のファイル名を" + $log_filename + "に出力します"
...
# 現在のディレクトリにあるファイル名のうち、拡張子.mp3がついたファイルのみ抽出取得して
# フルパス付ファイル名をPS1_test.logファイルの中に出力したい
